...
dag = DAG(
    dag_id='customers_incremental_load_to_deltatable',
...
batch_name = f'customers-incremental-load-{timestamp}'

pyspark_script = "gs://ecommerce_de_project_97/Spark_Folder/scripts/customers_incremental_load_pyspark_script.py"
...
submit_batch_task = DataprocCreateBatchOperator(
    task_id='customers_incremental_load',
    region='us-central1',
