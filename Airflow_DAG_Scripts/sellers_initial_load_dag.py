...
dag = DAG(
    dag_id='sellers_initial_load_to_deltatable',
...
pyspark_script = "gs://ecommerce_de_project_97/Spark_Folder/scripts/sellers_initial_load_pyspark_script.py"
...
submit_batch_task = DataprocCreateBatchOperator(
    ...
    batch_id='sellers-initial-load-to-deltatable',
    dag=dag
)
