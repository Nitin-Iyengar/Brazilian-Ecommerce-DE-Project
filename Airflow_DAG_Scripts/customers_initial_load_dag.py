...
dag = DAG(
    dag_id='customers_initial_load_to_deltatable',
...
pyspark_script = "gs://ecommerce_de_project_97/Spark_Folder/scripts/customers_initial_load_pyspark_script.py"
...
submit_batch_task = DataprocCreateBatchOperator(
    task_id='customers_initial_load',
    region='us-central1',
    ...
    batch_id='customers-initial-load-to-deltatable',
    dag=dag
)
