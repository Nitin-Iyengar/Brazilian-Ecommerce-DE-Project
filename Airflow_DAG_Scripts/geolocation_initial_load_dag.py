...
dag = DAG(
    dag_id='geolocation_initial_load_to_deltatable',
...
pyspark_script = "gs://ecommerce_de_project_97/Spark_Folder/scripts/geolocation_initial_load_pyspark_script.py"
...
submit_batch_task = DataprocCreateBatchOperator(
    task_id='geolocation_initial_load',
    region='us-central1',
    ...
    batch_id='geolocation-initial-load-to-deltatable',
    dag=dag
)
