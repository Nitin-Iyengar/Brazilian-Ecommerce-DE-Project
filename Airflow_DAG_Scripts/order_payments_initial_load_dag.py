...
dag = DAG(
    dag_id='order_payments_initial_load_to_deltatable',
...
pyspark_script = "gs://ecommerce_de_project_97/Spark_Folder/scripts/order_payments_initial_load_pyspark_script.py"
...
submit_batch_task = DataprocCreateBatchOperator(
    task_id='order_payments_initial_load',
    region='us-central1',
    ...
    batch_id='order-payments-initial-load-to-deltatable',
    dag=dag
)
